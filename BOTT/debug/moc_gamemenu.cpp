...
#include "../../../../../../../Projects/Battle-of-the-Towns/BOTT/gamemenu.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GameMenu_t, stringdata) + ofs \
...
const QMetaObject GameMenu::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GameMenu.data,
      qt_meta_data_GameMenu,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GameMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GameMenu.stringdata))
        return static_cast<void*>(const_cast< GameMenu*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< GameMenu*>(this));
