...
public:
    ...
    void setupUi(QDialog *Message)
    {
        ...
        Message->resize(354, 161);
        Message->setMinimumSize(QSize(354, 161));
        Message->setMaximumSize(QSize(354, 161));
    ...
    void retranslateUi(QDialog *Message)
    {
        ...
        label->setText(QApplication::translate("Message", "TextLabel", 0));
        pushButton->setText(QApplication::translate("Message", "Ok", 0));
    } // retranslateUi
