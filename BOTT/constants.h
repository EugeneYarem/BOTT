...
namespace army_upgrade_coefficients {
...
// General (for view.cpp, widget.cpp and some others)
namespace general {
    ...
    extern const int UPGRADES_COUNT;
...
namespace troops_configuration {
...
inline int getMinPriceUpgrade()
{
    ...
    {
        std::vector<int> vec;
        vec.push_back(upgrades_price::ARMOR_PRICE);
        vec.push_back(upgrades_price::ARQUEBUS_PRICE);
        vec.push_back(upgrades_price::DOCTORS_PRICE);
        vec.push_back(upgrades_price::HAUBERK_PRICE);
        vec.push_back(upgrades_price::MAGE_ATTACK_PRICE);
        vec.push_back(upgrades_price::MAGE_HP_PRICE);
        vec.push_back(upgrades_price::MINE_LEVEL_UP_PRICE);
        vec.push_back(upgrades_price::QUARANTINE_PRICE);
        vec.push_back(upgrades_price::WEAPON_PRICE);
